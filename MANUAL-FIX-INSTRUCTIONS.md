# 🔧 KASTORIA FM WEBAPP FIX - MANUAL STEPS

**Status**: Automated access blocked by Cloudflare. Manual steps required.

## ⚡ URGENT ACTION REQUIRED

The stream proxy is **WORKING** ✅  
The webapp page needs **ONE NEW SNIPPET** to display properly.
...
- Go to: https://kastoriafm.gr/wp-login.php
- Username: `super@dmin`
- Password: `Super@dmin1992@@`

### 2. Go to Code Snippets
- In left sidebar, click **Snippets**
- Or go directly to: https://kastoriafm.gr/wp-admin/admin.php?page=snippets

### 3. Delete the Broken Snippet
- Find snippet titled: **"Webapp Player HTML Content"**
- Click **Delete** (or **Deactivate** if Delete not available)
- This snippet was showing raw HTML text on the page

### 4. Add New Snippet
- Click **Add New** button at top of page

### 5. Fill in Snippet Details
- **Title**: `Kastoria FM Webapp Page`
- **Description**: `Serves standalone player page for /webapp bypassing theme`
- **Scope**: Select **"Run everywhere"** or **"Global"**

### 6. Paste the Code
**IMPORTANT**: Do **NOT** include `<?php` tag at the start!

Copy and paste this **EXACT** code into the code editor:
...
- OR click **"Save"** then toggle to **Active**

### 8. Verify Webapp Page Exists
- Go to **Pages** in WordPress admin
- Look for page titled **"Web App"** with slug `/webapp`
- If it doesn't exist, create it:
  - Click **Add New** page
  - Title: `Web App`
  - Slug: `webapp` (set in permalink)
  - Content can be EMPTY
  - Click **Publish**

### 9. Clear Cache (Optional)
- If WP Rocket plugin is active:
  - Go to **WP Rocket** settings
  - Click **"Clear Cache"**
- Hard refresh your browser: `Ctrl+Shift+R` (Windows) or `Cmd+Shift+R` (Mac)

### 10. Test the Player
- Visit: https://kastoriafm.gr/webapp/
- You should see:
  - ✅ Kastoria FM logo centered
  - ✅ Clean gradient background (no theme header/footer)
  - ✅ Large round PLAY button
  - ✅ Volume slider
  - ✅ "Live · 91.5" indicator
- Click **PLAY**
- Status should change to: **"Παίζει ζωντανά"**
- Audio should play!
...
**Snippet Active**: YES  
**Page Published**: YES  
**Player UI Visible**: YES (clean, no theme elements)  
**Audio Plays**: YES
...
### If raw HTML still shows:
1. Make sure the OLD snippet ("Webapp Player HTML Content") is DELETED
2. Make sure the NEW snippet is ACTIVE
3. Clear browser cache completely

### If audio doesn't play:
1. Check that "Kastoria FM Stream Proxy" snippet is also ACTIVE
2. Test stream directly: https://kastoriafm.gr/?kastoria_stream=1
3. Try different browser

### If theme header/footer still show:
- The new snippet should completely bypass the theme
- Make sure you pasted the FULL code correctly
- Check for any PHP errors in snippet

---

## 📁 FILES CREATED

All required code has been saved to:
- `/workspace/wordpress-page/webapp-snippet-final.php` - The snippet code (without <?php tag)
- Copy this file content directly into Code Snippets editor

---

## ⏱️ TIME ESTIMATE

This fix should take **5-10 minutes** to complete manually.

---

**REMEMBER**: Do NOT include `<?php` at the start of the code when pasting into Code Snippets!
